...
/**
 * Below example shows how to create a simple generics class with two type parameters. Look at the class definition, we
 * defined two types of parameters called U & V, seperated by ",". You can define multiple type parameters seperated by
 * ",". Look at sample code for more comments. - See more at:
 * http://java2novice.com/java-generics/two-type-parameters/#sthash.TTbQGjlK.dpuf
 */
