...
// Below example shows how to create vector object, adding elements to it, getting elements by specifying index, getting
// elements index, getting first element, getting last element, and is vector is empty or not. - See more at:
// http://java2novice.com/java-collections-and-util/vector/basic-operations/#sthash.bKGhI8LX.dpuf
