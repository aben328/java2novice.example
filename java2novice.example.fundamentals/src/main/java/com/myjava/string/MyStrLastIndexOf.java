...
/**
 * Below example shows how to get index of a given character or string from a string in the reverse order, means last
 * occuring index. By using lastIndexOf() method you can get last occurence of the the reference string or character.
 * Also lastIndexOf() method gives last occurence based on a specific position. 
 * @See more at:
 * http://java2novice.com/java_string_examples/last_index_of/#sthash.4iQO6Nih.dpuf
 * @author sony
 */
public class MyStrLastIndexOf {
	...
	public static void main(String a[]) {
		...
		/**
		 * Returns the last occurance from specified start index, searching backward starting at the specified index.
		 */
